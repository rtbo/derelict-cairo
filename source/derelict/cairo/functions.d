module derelict.cairo.functions;

import derelict.cairo.types;
...
extern(C) {
    ...
    */
    ...
    version (CairoNoPngFunctions) {}
        ...
        alias da_cairo_surface_write_to_png = cairo_status_t function (cairo_surface_t	*surface,
                        const (char)	*filename);

        alias da_cairo_surface_write_to_png_stream = cairo_status_t function (cairo_surface_t	*surface,
                           cairo_write_func_t	write_func,
                           void			*closure);
    }
    ...
    version (CairoNoPngFunctions) {}
        ...
        alias da_cairo_image_surface_create_from_png_stream = cairo_surface_t * function (cairo_read_func_t	read_func,
                                void		*closure);
